...
import { FlashcardSessionView, FlashcardSessionRequest } from 'generated/index';
...
export function useFlashcardSession(flashcardId: string) {
  ...
  }, [user?.id, flashcardId, resetAutoPauseTimer, startSessionMutation]);
  ...
  const endSession = useCallback(
    ...
    [currentSession?.id, endSessionMutation]
  );
  ...
  }, [currentSession?.id, resetAutoPauseTimer, resumeSessionMutation]);
  ...
  const abandonSession = useCallback(
    ...
    [currentSession?.id, abandonSessionMutation]
  );
